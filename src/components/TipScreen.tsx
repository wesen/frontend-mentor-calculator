...
export const TipScreen: React.FunctionComponent<Props> = (props) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full desktop:h-screen w-full bg-logo-bg">
      <div className="h-32 desktop:h-1/6 flex flex-col items-center desktop:-mt-48 justify-center w-full">
        <svg
          width="87"
          height="54"
          viewBox="0 0 87 54"
      ...
      <div
        className="
        bg-white rounded-t-3xl desktop:rounded-3xl p-8 flex
